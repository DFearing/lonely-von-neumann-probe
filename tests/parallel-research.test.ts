...
describe("parallel research mechanics", () => {
  ...
  describe("research speed multiplier", () => {
    test("computing_speed_t1 increases research progress rate by 1.06x", () => {
      const project = makeResearchProject("energy_production_t1");
    ...
    test("computing_speed_t1 + computing_speed_t3 stack research speed", () => {
      const project = makeResearchProject("energy_production_t1");
